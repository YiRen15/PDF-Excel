...
title 动态心电图 PDF 转 Excel Web 启动工具 (PDF-Excel 1.01.00-simple)

echo ==================================================
echo    动态心电图 PDF 转 Excel - 基础精简版 [版本: 1.01.00-simple]
echo ==================================================
echo.
echo [系统日志] 启动时间: %DATE% %TIME%
echo [系统日志] 当前工作路径: %CD%
echo.
